                                ...
                                <div class="col-sm-12">
                                    <form class="form-horizontal" role="form" id="form1" method="post" action="">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" placeholder="登录名" id="loginname"
                                                       name="loginname" value="<%=info.getLoginname() %>">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" placeholder="用户名" id="username"
                                                       name="username" value="<%=info.getUsername() %>">
                                            </div>
                                            <p class="col-sm-6 help-block">必填</p>
                                        </div>
                                        <hr/>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" placeholder="联系方式" id="phone"
                                                       name="phone" value="<%=info.getPhone() %>">
                                            </div>
                                            <p class="col-sm-6 help-block"></p>
                                        </div>
                                        <hr/>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">所属角色<input type="hidden" name="roleid"
                                                ...
                                                <div class="radio">
                                                    <label>
                                                        <input type="radio" name="roles"
                                                               ...
                                                               <%if(roles.get(i).getId()==info.getRoleid()){ %>checked<%} %> ><%=roles.get(i).getRolename() %>
                                                    </label>
                                                </div>
                                                <%} %>
                                                <%} %>

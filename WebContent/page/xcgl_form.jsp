                                    ...
                                    <form class="form-horizontal" role="form" id="form1" method="post" action="">
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">
                                            	...
                                            	<input id="pic" type="hidden" value="<%=info.getPic() %>" name="pic"/>
                                            </label>
                                            <div class="col-sm-4">
                                            	<%if(info.getPic() != null && !"".equals(info.getPic())){ %>
                                            	<img class="left" id="lpath" src="<%=contextPath%>/awt/<%=info.getPic() %>" height="200px" width="200px" ></img>
                                            	<%}else{ %>
                                            	<img class="left" id="lpath" src="<%=contextPath%>/awt/default.jpg" height="200px" width="200px" ></img>
                                            	<%} %>
                                            	<div id="uploader" >
    												<!--用来存放文件信息-->
    												<div id="thelist"></div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" placeholder="相册名称" id="xcmc" name="xcmc" value="<%=info.getXcmc() %>">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" placeholder="相册编号" name="xcseq" value="<%=info.getXcseq() %>">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <textarea class="form-control" style="height: 100px;" name="remark" maxlength="500" placeholder="相册说明"><%=info.getRemark() %></textarea>
                                            </div>
                                            <p class="col-sm-6 help-block"></p>
                                        </div>
                                        <hr/>

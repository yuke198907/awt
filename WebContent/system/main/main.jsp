            ...
            <span>
                <div>
                    <a href="#" data-toggle="dropdown">
                        <i class="fa fa-user"></i><span class="name"><%=user.getUsername() %></span><span class="caret"></span>
                    </a>
        ...
        <script id="nav_tpl" type="text/html">
			...
			<ul>
				...
				<li>
					...
					<ul>
						<%if("admin".equals(user.getLoginname()) || user.getPermission().contains("D")){ %><li><a href="#" onclick="loadURL('/page/xcgl_list.jsp')"><i class="fa fa-fw fa-file"></i><span>相册管理</span></a></li><%} %>
					</ul>
				</li>
				<%} %>
            </ul>
